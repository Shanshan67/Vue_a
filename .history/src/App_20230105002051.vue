...
export default {
  ...
  mounted(){
    ...
    this.emitter.on('clearAllTodo',this.clearAllTodo)
    this.emitter.on('checkAllTodo',this.checkAllTodo)
  ...
  beforeDestroy(){
    ...
    this.emitter.off('clearAllTodo')
    this.emitter.off('checkAllTodo')
    this.emitter.off('deleteTodo')
  }
}
</script>
